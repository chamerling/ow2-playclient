...
// push a message to a resource
PlayClient.prototype.publish = function(resource, payload, callback) {
  callback = utils.safe(callback);
  this._form('publish', {resource : resource, message : payload}, function(err, response) {
